...
That's not in the browser yet. For very large uploads where this matters, use [the CLI](/uploading/multipart-cli/) or roll your own [multipart over the API](/uploading/multipart-api/) — both store the `uploadId` and resume cleanly.
