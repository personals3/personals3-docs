...
1. **Free space** — see [What counts toward your quota](./what-counts.md) for the quickest wins (empty trash, drop transcodes you don't need).
2. **Ask for more** — see [Need more space?](./need-more-space.md). A 100 MB starter account can grow as needed.
